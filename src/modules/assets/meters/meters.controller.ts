...
export class MetersController {
  ...
  // ==========================================================================
  // MODULE LINK/UNLINK ENDPOINTS
  // ==========================================================================

  /**
   * Link a module (communication unit) to a meter
   * Module must be in WAREHOUSE status
   */
  @Post(':id/link-module')
  @RequirePermissions(PERMISSIONS.METER_UPDATE)
  async linkModule(
  ...
  /**
   * Unlink a module (communication unit) from a meter
   * Module status will be set to WAREHOUSE or MAINTENANCE
   */
  @Post(':id/unlink-module')
  @RequirePermissions(PERMISSIONS.METER_UPDATE)
  async unlinkModule(
    @Param('id', ParseUUIDPipe) id: string,
