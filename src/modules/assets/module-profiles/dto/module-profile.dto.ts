...
// Type alias - Prisma uses DeviceBrand but we expose as ModuleBrand
...
export class CreateModuleProfileDto {
  @IsEnum(DeviceBrand)
  @IsNotEmpty()
  brand: DeviceBrand;
...
export class UpdateModuleProfileDto {
  @IsOptional()
  @IsString()
  @IsNotEmpty()
  modelCode?: string;
...
export class ModuleProfileQueryDto {
  @IsOptional()
...
export {
  CreateModuleProfileDto as CreateDeviceProfileDto,
  UpdateModuleProfileDto as UpdateDeviceProfileDto,
  ModuleProfileQueryDto as DeviceProfileQueryDto,
};
